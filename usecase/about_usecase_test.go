...
func TestAboutUsecaseRenderTemplateWithGin(t *testing.T) {
	tpl := "template.html"

	t.Run("success", func(t *testing.T) {
		// Tạo một đối tượng use case mới
		u := usecase.NewAboutUsecase()
		...
		assert.Equal(t, "Hello "+domain.AboutTitle, w.Body.String())
	...
	t.Run("error", func(t *testing.T) {
		...
		// Định nghĩa endpoint API để kiểm tra use case
		r.GET("/render-template", func(c *gin.Context) {
