...
func TestHomeUsecaseRenderTemplateWithGin(t *testing.T) {
	tpl := "template.html"

	t.Run("success", func(t *testing.T) {
		// Tạo một đối tượng use case
		u := usecase.NewHomeUsecase()
		...
		assert.Equal(t, "Hello "+domain.HomeTitle, w.Body.String())
